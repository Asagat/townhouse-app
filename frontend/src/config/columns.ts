...
export const formFieldConfig: Record<string, string[]> = {
    ...
    payments: ['title', 'apartment_id', 'cash_point_id', 'transaction_type', 'article_id', 'amount', 'transaction_date', 'notes'],
    transactions: ['title', 'apartment_id', 'cash_point_id', 'transaction_type', 'article_id', 'amount', 'transaction_date', 'notes'],
