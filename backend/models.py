...
class Tariff(Base):
    ...
    # последний созданный тариф своего вида услуги (2.18: признака разовости нет);
    # при создании нового тарифа предыдущие помечаются архивными. Статус
    # информационный: расчёт начислений идёт по valid_from/valid_to.
    status = Column(
