...
| Август 2026 | В регистры добавлен столбец «Документ» (`document_title`): `accruals_register` — название документа начислений, `accounts_register` — название начисления или «Приход/Расход»; заголовок колонки «Документ» — единообразно с «Регистр показаний» |
