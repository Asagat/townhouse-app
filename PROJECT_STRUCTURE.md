...
| Август 2026 | В регистры добавлен столбец «Название документа»: `accruals_register` — название документа начислений, `accounts_register` — название начисления или «Приход/Расход» (через `document_title`) |
